...
// -- 6379, a well-known port to which the redis server listens to
// -- redis, is the link name of the container that runs redis server
...
client.set("/", "Welcome to Docker-Compose helper\nEnter thedocker-compose command in the URL for help\n", redis.print);
